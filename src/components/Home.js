...
const homeData = {
  ...
  img: "img/hero/2.jpg",
  bio: "Dynamic MERN stack developer ready to innovate and excel in fast-paced tech environments.",
  numberOfProject: 10,
};
    ...
    <div className="devman_tm_section" id="home">
      <div className="devman_tm_hero">
        <div className="background">
          <video autoPlay loop muted className="video-background" style={{ width: "100%" }}>
