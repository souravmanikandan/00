                ...
                <li className="wow fadeInUp" data-wow-duration="1s">
                  <div className="list_inner">
                    <div
                      ...
                      data-img-url="img/portfolio/orion.jpg"
                    />
                    ...
                    <a
                      ...
                      href="https://orion-frontend-api.vercel.app/"
                    />
                  </div>
                </li>
                <li className="wow fadeInUp" data-wow-duration="1s">
                  <div className="list_inner">
                    <div
                      className="background_image"
                      data-img-url="img/portfolio/calculator.jpg"
                    />
                    <div className="content">
                      <div className="details">
                        <span className="category">
                    ...
                    <a
                      ...
                      href="https://calculator-sourav-api.vercel.app/"
                    />
                  </div>
                </li>
                <li className="wow fadeInUp" data-wow-duration="1s">
